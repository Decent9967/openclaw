...
| Feishu     | Yes           | Yes (card edits in direct chats; unavailable for mention-required groups, `renderMode: raw`, and when modifying hooks are registered) | Yes | card status line for running tools |
